  ...
  ("info",
   [(store_script_param, ":player_id", 1),
     (try_begin),
       ...
       (multiplayer_send_string_to_player,":player_id", server_event_script_message, "@ '/vender casa (porta id)' vende uma casa"),
       (multiplayer_send_string_to_player,":player_id", server_event_script_message, "@ '/id' mostra o seu ou o id de alguem."),
       (multiplayer_send_string_to_player,":player_id", server_event_script_message, "@------------------------------------------------------------------------------"),
     (try_end),
